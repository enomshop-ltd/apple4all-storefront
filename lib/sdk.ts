...
const isProd = globalThis.Deno?.env?.get("DENO_ENV") === "production" || globalThis.Deno?.env?.get("NODE_ENV") === "production";

if (isProd && (!PUBLISHABLE_KEY || !BACKEND_URL)) {
  throw new Error("CRITICAL: MEDUSA_PUBLISHABLE_KEY and MEDUSA_BACKEND_URL environment variables must be set in production.");
}
...
export const medusa = new Medusa({
  ...
  publishableKey: PUBLISHABLE_KEY || "pk_18a6d80c3b15f3c67c33a0cec589d3865dc023f338da36463d3b72205290870c",
  debug: false,
});
