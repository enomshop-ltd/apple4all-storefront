      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20 items-start">
        ...
        <div class="lg:col-span-7 rounded-3xl p-2 md:p-8 relative group transition-shadow">
          ...
          <div class="relative z-10 flex justify-between items-center mb-6">
            ...
            <a href="/repairs/book" f-client-nav={false} class="mr-4 md:mr-0 px-4 py-2 bg-slate-900 text-white rounded-lg hover:bg-slate-800 transition font-medium text-sm">
              Book a Repair
            </a>
          </div>
