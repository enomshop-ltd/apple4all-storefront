...
export const handler = define.handlers({
  GET(ctx) {
    ctx.state.title = "Financing Options - Apple4All";
    ctx.state.description =
      "Flexible financing options for purchasing refurbished Macs at Apple4All in Westlands, Nairobi.";
    return page();
  },
});
    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="text-center mb-16">
        ...
        <p class="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
          At Apple4All, we believe premium technology should be accessible.
