...
export const handler = define.handlers({
  GET(ctx) {
    ctx.state.title = "Our Story - Apple4All";
    ctx.state.description =
      "Learn about Apple4All, a premier tech shop in Westlands, Nairobi specializing in Mac sales and services.";
    return page();
  },
});
  ...
  return (
    <div class="prose prose-blue max-w-none">
      ...
      <img
        ...
        alt="Apple4All Storefront in Westlands"
