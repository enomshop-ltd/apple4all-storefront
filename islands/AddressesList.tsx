...
import { Edit2, Plus, Trash2 } from "lucide-preact";
import { HttpTypes } from "@medusajs/types";

export function AddressesList(
  { initialAddresses }: { initialAddresses: HttpTypes.StoreCustomerAddress[] },
) {
  const [addresses, _setAddresses] = useState(initialAddresses || []);
